...
public partial class BatchImportViewModel : ViewModelBase
{
    ...
    public BatchImportViewModel(IDocumentRepository repository, IDialogService dialogService, INavigationService navigationService)
    {
