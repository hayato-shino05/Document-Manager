...
public partial class BulkDeleteViewModel : ViewModelBase
{
    ...
    public BulkDeleteViewModel(IDocumentRepository repository, IDialogService dialogService, INavigationService navigationService)
    {
