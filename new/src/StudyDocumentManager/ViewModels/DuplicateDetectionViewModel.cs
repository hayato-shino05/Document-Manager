...
public partial class DuplicateDetectionViewModel : ViewModelBase
{
    ...
    public DuplicateDetectionViewModel(IDocumentRepository repository, IDialogService dialogService)
    {
