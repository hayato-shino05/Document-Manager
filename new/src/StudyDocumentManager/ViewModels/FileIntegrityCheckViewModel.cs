...
public partial class FileIntegrityCheckViewModel : ViewModelBase
{
    ...
    public FileIntegrityCheckViewModel(IDocumentRepository repository, IDialogService dialogService)
    {
