...
public partial class PersonalNoteViewModel : ViewModelBase
{
    ...
    public PersonalNoteViewModel(IDialogService dialogService, INavigationService navigationService)
    {
